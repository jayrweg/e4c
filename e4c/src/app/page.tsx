...
export default function Home() {
  ...
  useEffect(() => {
    ...
    async function loadFeaturedGallery() {
      ...
      setFeaturedGallery([
        { id: '1', title: 'Community Event', description: 'Empowering women in the community', image: '/gallery/gallery-1.jpg', category: 'community' },
        { id: '2', title: 'Health Workshop', description: 'SRH awareness workshop', image: '/gallery/gallery-2.jpg', category: 'workshop' },
        { id: '3', title: 'Training Session', description: 'Skills training for women', image: '/gallery/gallery-3.jpg', category: 'training' },
        { id: '4', title: 'Community Outreach', description: 'Reaching out to local communities', image: '/gallery/gallery-4.jpg', category: 'outreach' },
        { id: '5', title: 'Advocacy Event', description: 'Advocacy for women rights', image: '/gallery/gallery-5.jpg', category: 'advocacy' },
        { id: '6', title: 'Group Discussion', description: 'Interactive group sessions', image: '/gallery/gallery-6.jpg', category: 'discussion' },
      ]);
    }

    async function loadFeaturedEvents() {
      // Events will be loaded from static events page
      setFeaturedEvents([]);
    }
      ...
      setTeamMembers([
        {
          ...
          memberType: 'board',
          photo: '/team/judith-justine-kweka.jpg',
        ...
        },
        {
          ...
          role: 'Board Member',
          memberType: 'board',
          photo: '/team/alice-henry-mbowe.jpg',
        ...
        },
        {
          ...
          role: 'Board Member',
          memberType: 'board',
          photo: '/team/Agusta Kinunda1.jpg',
        ...
        },
        {
          ...
          memberType: 'team',
          photo: '/team/Lightness-Limbe.jpg',
