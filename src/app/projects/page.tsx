...
export default async function Projects() {
  ...
  const formattedProjects = projects.map((project: any) => ({
    ...
    status: project.status === 'ongoing' ? 'Active' : project.status === 'completed' ? 'Completed' : 'Planned',
    impact: project.beneficiaries ? `${project.beneficiaries}+ people reached` : 'Making a difference',
