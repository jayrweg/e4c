...
export default async function Events() {
  ...
  const formattedEvents = events.map((event: any) => ({
    ...
    image: event.image ? urlForImage(event.image).url() : 'https://images.unsplash.com/photo-1511578314322-379afb476865?ixlib=rb-4.0.3&auto=format&fit=crop&w=1976&q=80',
